<p class="frm6 frm_form_field">
	<label for="field_options_admin_only_<?php echo absint( $field['id'] ); ?>">
		<?php esc_html_e( 'Visibility', 'formidable-pro' ); ?>
		<span class="frm_help frm_icon_font frm_tooltip_icon frm_tooltip_expand" data-placement="right" title="<?php esc_attr_e( 'Determines who can see this field. The selected user role and higher user roles will be able to see this field. The only exception is logged-out users. Only logged-out users will be able to see the field if that option is selected.', 'formidable-pro' ) ?>"></span>
	</label>
